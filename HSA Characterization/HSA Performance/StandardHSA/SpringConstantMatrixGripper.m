...
rotSteps = thetaStart:thetaDelta:thetaEnd;
 ...
 %% Load Data and plot
Data = readtable('HSAGripper-TestSet2-5Apr-8RowHSA.csv');
...
% colorbar
 ...
 if saveData == true
     ...
     writetable(saveVals,'HSA_GRIPPER_SpringConstantData_StandardHSA.csv');

     testSavedData = readtable('HSA_GRIPPER_SpringConstantData_StandardHSA.csv','PreserveVariableNames',true);
     fprintf('\n Data saved to file with name: \n HSA_GRIPPER_SpringConstantData_StandardHSA.csv \n\n')

...
# new_length = disp1 + original_length
# new_length
# new_data = instron_data[instron_data['Displacement1'] < 1] # displacement less than 1 mm
# new_data
...
# plt.plot(specimen1['Displacement'], specimen1['Force'], label = 'Specimen 1')
plt.plot(specimen2['Displacement'], specimen2['Force'], label = 'Specimen 2')
# plt.plot(specimen3['Displacement'], specimen3['Force'], label = 'Specimen 3')
